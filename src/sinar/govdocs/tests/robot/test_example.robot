...
#
#  $ bin/test -s sinar.govdocs -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sinar.govdocs.testing.SINAR_GOVDOCS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sinar/govdocs/tests/robot/test_example.robot
#
